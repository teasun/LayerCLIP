...
new_class_names = ['aeroplane', 'bicycle', 'bird avian', 'boat', 'bottle,beverage bottle,bottle label',
...
new_class_names_coco = ['person with clothes,people,human', 'bicycle', 'car', 'motorbike', 'aeroplane',
                        ...
                        'glove', 'skateboard', 'surfboard', 'tennis racket', 'bottle,beverage bottle,bottle label',
